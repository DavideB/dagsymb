...
public class GuardEvaluatorPromoCallsFile implements IGuardEvaluator {
    ...
    private void evaluateActualGuards() {
        ...
        if (
           ...
           ( !arg3_known || 	arg3 >= 0 ) &&
           ( !arg3_known || 	arg3 <= 2 ) &&
           ( !count_PromoCalls_java_42_0_known || !arg1_known || 	count_PromoCalls_java_42_0 - arg1 <= 0 ) &&
           ( !arg2_known || !count_PromoCalls_java_45_0_known || 	count_PromoCalls_java_45_0 - arg2 > 0 ) &&
        true) {
