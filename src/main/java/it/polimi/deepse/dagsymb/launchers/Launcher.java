...
public class Launcher {
   ...
   */
    ...
    public static void main(String[] args) {
      ...
      UserCallDB.addCallsToLast24HoursLocalCalls(Integer.parseInt(args[1]), Integer.parseInt(args[2]));
      UserCallDB.addCallsToLast24HoursAbroadCalls(Integer.parseInt(args[3]), Integer.parseInt(args[4]));
      UserCallDB.addCallsToMonthCalls(Integer.parseInt(args[5]), Integer.parseInt(args[6]));
      promoCalls0.run(Integer.parseInt(args[7]), Integer.parseInt(args[8]), Integer.parseInt(args[9]), Integer.parseInt(args[10]));
  }
}
